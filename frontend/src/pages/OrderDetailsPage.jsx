...
const OrderDetailsPage = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto p-4 sm:p-6 bg-gray-50 font-serif'>
            ...
            {!orderDetails ? (
                ...
                <div className='p-6 sm:p-8 bg-white rounded-xl shadow-lg'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8 text-gray-700'>
                        <div>
                    ...
                    <div className='overflow-x-auto'>
                        ...
                        <table className='min-w-full text-gray-600 mb-8 bg-white rounded-lg shadow'>
                            ...
                            <tbody>
                                {orderDetails.orderItems.map((item) => (
                                    <tr key={item.productId} className='border-b border-gray-200 hover:bg-teal-50 transition-colors'>
                                        ...
                                        <td className="py-4 px-4 text-gray-700 font-medium">{item.quantity}</td>
                    ...
                    {/* Back to orders link  */}
                    <Link
                        to="/my-orders" className='text-teal-700 hover:underline font-semibold'>
                        Back to My Orders
                    </Link>
                </div>
